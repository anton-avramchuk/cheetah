...
public class GetAllRolesQueryHandler(IGridRepository<AppNameIdentityRole> repository)
    : Cheetah.Modules.Identity.Application.Queries.GetAllRolesQueryHandler<AppNameIdentityRole>(repository)
{
}
