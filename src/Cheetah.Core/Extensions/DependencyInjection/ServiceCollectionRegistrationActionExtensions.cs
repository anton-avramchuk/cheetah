...
namespace Cheetah.Core.Extensions.DependencyInjection;
...
public static class ServiceCollectionRegistrationActionExtensions
{
    ...
    public static void DisableCrmClassInterceptors(this IServiceCollection services)
    {
        GetOrCreateRegistrationActionList(services).IsClassInterceptorsDisabled = true;
    }

    public static bool IsCrmClassInterceptorsDisabled(this IServiceCollection services)
    {
