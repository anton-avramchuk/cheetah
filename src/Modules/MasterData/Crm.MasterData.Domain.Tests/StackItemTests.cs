...
namespace Crm.MasterData.Domain.Tests;
...
public class StackItemTests
{
    ...
    public void Create_WithValidName_ShouldCreateEntity()
    {
        ...
        // Act
        var entity = StackItem.Create(name);
    ...
    public void Create_WithNameAndDescription_ShouldCreateEntity()
    {
        ...
        // Act
        var entity = StackItem.Create(name, description);
    ...
    {
        // Act
        var entity1 = StackItem.Create("Entity 1");
        var entity2 = StackItem.Create("Entity 2");
    ...
    {
        // Arrange
        var entity = StackItem.Create("Original Name", "Original Description");
    ...
    {
        // Arrange
        var entity = StackItem.Create("Original Name");
