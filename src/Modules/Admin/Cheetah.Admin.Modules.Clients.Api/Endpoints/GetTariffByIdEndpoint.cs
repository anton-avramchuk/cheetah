...
public class GetTariffByIdEndpoint : QueryOrNotFoundEndpoint<GetTariffByIdRequest, GetTariffByIdQuery, TariffModel, TariffViewModel>
{
    public override string Route => $"{Constants.TariffsRoute}/{{id:guid}}";

    protected override void Configure(EndpointConfiguration config)
    {
        config.WithName("GetTariffById");
    }
}
