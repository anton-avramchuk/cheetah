...
public class DeleteUserCommandHandlerTests
{
    ...
    private readonly DeleteUserCommandHandler<StubUser, StubRole> _handler;
    ...
    public DeleteUserCommandHandlerTests()
    {
        ...
        _handler = new DeleteUserCommandHandler<StubUser, StubRole>(_userManagerMock.Object, new NullEventBus());
    }
