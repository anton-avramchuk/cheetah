...
public class UserIdentityTests
{
    ...
    public void Create_WithValidName_ShouldCreateEntity()
    {
        ...
        // Act
        var entity = UserIdentity.Create(name);
    ...
    public void Create_WithNameAndDescription_ShouldCreateEntity()
    {
        ...
        // Act
        var entity = UserIdentity.Create(name, description);
    ...
    {
        // Act
        var entity1 = UserIdentity.Create("Entity 1");
        var entity2 = UserIdentity.Create("Entity 2");
    ...
    {
        // Act
        var act = () => UserIdentity.Create(name!);
    ...
    {
        // Arrange
        var entity = UserIdentity.Create("Original Name", "Original Description");
    ...
    {
        // Arrange
        var entity = UserIdentity.Create("Original Name");
