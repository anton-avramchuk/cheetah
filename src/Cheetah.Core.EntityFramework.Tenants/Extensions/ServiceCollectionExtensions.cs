...
public static class ServiceCollectionExtensions
{
    ...
    {
        public IServiceCollection AddTenantsDbContext<TDbContext, TTenant, TTenantCreatedEvent, TTenantUpdatedEvent, TTenantDeactivatedEvent, TTenantActivatedEvent>()
        ...
        /// </summary>
        public IServiceCollection AddTenantDatabaseMigrationManager<TTenantCreatedEvent>()
            where TTenantCreatedEvent : TenantCreatedEvent
        {
