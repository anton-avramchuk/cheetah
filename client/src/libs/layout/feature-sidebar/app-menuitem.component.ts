// Скопировано из sakai-ng/src/app/layout/component/app.menuitem.ts
// Изменено: убран providers: [LayoutService] (приводил к созданию отдельного экземпляра на каждый пункт)
...
export class AppMenuitem {
    ...
    updateActiveStateFromRoute(): void {
        ...
        if (activeRoute) this.layoutService.onMenuStateChange({ key: this.key, routeEvent: true });
    }
    ...
    get activeClass(): boolean { return this.active && !this.root; }
